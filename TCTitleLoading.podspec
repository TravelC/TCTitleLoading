#
#  Be sure to run `pod spec lint TCTitleLoading.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version      = "0.0.1"
  s.summary      = "A short description of TCTitleLoading."
  ...
  # Or just: s.author    = "Travel.Chu"
  # s.authors            = { "Travel.Chu" => "chuchuanming@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Travel.Chu"
